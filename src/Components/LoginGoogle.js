...
export const LoginGoogle = () => {
  ...
  const doUserLogIn = async function () {
    ...
    try {
      const loggedInUser = await Parse.User.logIn(usernameValue, passwordValue,{email:"clicktabweb@gmal.com"});
      ...
      getCurrentUser();
      encryptStorage.setItem('user_clicktabweb',{username,password});
    ...
    <div>
      <div className="header">
        <img
          ...
          alt="Back4App Logo"
          src={
            '../Images/clicktabweblogo.jpg'
          }
        />
        <p className="header_text_bold">{'ClickTabWeb'}</p>
        ...
        <div className="container">
          ...
          <p className="form__hint">Don't have an account? <a className="form__link" href="/register">Sign up</a></p>
          <p className="form__hint">Reset Password? <a className="form__link" href="/passwordreset">reset password</a></p>
        </div>
    </div>
  );
};